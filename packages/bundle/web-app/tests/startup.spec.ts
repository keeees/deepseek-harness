...
describe('web command-line provider', () => {
  ...
  // Fork divergence: upstream rejects this host as remote code execution
  // exposure. This deployment serves the network knowingly, so the flag now
  // reaches the consumer like any other bind host.
  it('passes the all-interfaces host through to the consumer', async () => {
